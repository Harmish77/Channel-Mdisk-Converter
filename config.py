...
CHANNEL_ID = list(int(i.strip()) for i in os.environ.get("CHANNEL_ID").split("-1001210024474")) if os.environ.get("CHANNEL_ID") else []
...
USERNAME = os.environ.get("USERNAME", "main_movie_hub")
